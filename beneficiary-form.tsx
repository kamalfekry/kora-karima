...
const formSchema = z.object({
  ...
  idCardImage: z.any().refine((file) => file?.length > 0, "يجب رفع صورة البطاقة الشخصية"),
  phone1: z.string().regex(/^(010|011|012|015)\d{8}$/, "رقم الهاتف غير صحيح"),
  phone2: z
    .string()
    .regex(/^(010|011|012|015)\d{8}$/, "رقم الهاتف غير صحيح")
    .optional()
    .or(z.literal("")),
  whatsapp: z.string().regex(/^(010|011|012|015)\d{8}$/, "رقم الواتساب غير صحيح"),
